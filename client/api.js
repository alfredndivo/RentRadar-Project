...
export const getUserMessages = () => API.get('/messages/user');
export const getLandlordMessages = () => API.get('/messages/landlord');
export const sendMessage = (data) => API.post('/messages/send', data);
export const getConversationWith = (receiverId) => API.get(`/messages/conversation/${receiverId}`);
